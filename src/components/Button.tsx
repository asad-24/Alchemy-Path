...
export default function Button({ 
  ...
  const baseStyles = "inline-block px-10 py-4 rounded-full text-sm font-medium tracking-wider uppercase transition-all duration-500 text-center transform hover:-translate-y-1";
