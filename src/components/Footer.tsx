...
export default function Footer() {
  return (
    <footer className="bg-[#0B0B0B] text-[#F7F5F2] pt-20 pb-12">
           ...
           <Link href="/" className="flex items-center gap-3 group">
            ...
            <div className="space-y-3">
              <a 
                ...
                className="text-sm opacity-60 hover:opacity-100 hover:text-[#C6A86B] transition-all font-light block"
              >
              ...
              <div className="flex items-center gap-4 pt-2">
                ...
                <a 
                  href="https://www.facebook.com/profile.php?id=61575452295130" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="opacity-60 hover:opacity-100 hover:text-[#C6A86B] transition-all"
                  aria-label="Facebook"
